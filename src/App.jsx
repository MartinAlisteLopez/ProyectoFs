          ...
          <div className="container-fluid">
            <nav className="navbar navbar-expand-lg custom_nav-container ">
              ...
              <div className="ml-auto d-none d-lg-block" id="userMenu">
                <span className="navbar-text mr-3" id="userName">Bienvenido</span>
                <button className="btn btn-outline-light btn-sm" id="btnCerrarSesion">
                  Cerrar Sesión
                </button>
              </div>
              ...
              <form className="form-inline my-2 my-lg-0 ml-0 ml-lg-4 mb-3 mb-lg-0 d-none d-lg-block">
                <button className="btn my-2 my-sm-0 nav_search-btn" type="submit" aria-label="Buscar"></button>
              </form>
            </nav>
          </div>
        </header>
        ...
        <section className="about_section layout_padding reveal" id="about">
          <div className="container">
            ...
            <p className="layout_padding2-bottom">
              Te invitamos a leer más sobre nuestra historia, misión y valores en la sección "Nosotros". Descubre cómo
              Stroms Solutions se ha convertido en una empresa de confianza para miles de clientes que buscan soluciones
              eléctricas profesionales y eficientes.
            </p>
          </div>
          <div className="container">
            <div className="btn-box">
